// src/data/microCourses.js
// DayOne.ai Micro-Learning Modules Database v2.0
// Official curriculum covering Frontend, Backend, Full Stack, UI/UX, Cybersecurity, and Data Analytics.
...
/**
 * Extracts YouTube video ID if URL is standard format
 */
...
/**
 * Returns a high-res image for the module:
 * Uses YouTube thumbnail if valid video ID exists, else uses domain image.
 */
...
/**
 * Normalizes a role identifier to standard key in curriculum
 */
...
/**
 * Retrieves all micro-learning modules for a given role
 */
...
/**
 * Finds the single best matching micro-learning course module from the curriculum
 * based on the candidate's diagnosed weakness or gap area.
 */
export function findMicroCourseForWeakness(roleId, weaknessQuery = '') {
  ...
  if (!bestMatch || highestScore <= 0) {
    // Specific sensible defaults per role:
